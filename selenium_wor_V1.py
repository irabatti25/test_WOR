...
enter_text=driver.find_element_by_xpath("//input[@name='query']").send_keys("Software Testing")
time.sleep(3)
#Click on 'Find me some tangents'
serch=driver.find_element_by_xpath("//button[text()='Find me some tangents!']").click()
time.sleep(3)
#Go to the any Url
elem=driver.find_element_by_xpath('//a[@href="http://www.reddit.com/comments/3jmj9z/x/cuqt025"]').click()
